...
export const metadata: Metadata = {
  ...
  description:
    'A friendly, visual PoE 3.27 getting started guide. Learn the basics: leveling, loot filters, trading, defenses, flasks, atlas, and early mapping with clear screenshots.',
