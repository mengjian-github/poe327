...
export default function ForgedFrostbearerSpectreNecromancer({ meta }: CuratedProps) {
  return (
    <div>
      ...
      <GuideSection title="Leveling Route">
        <div className="space-y-8">
          <MediaCard
            image="/images/starters/forged-frostbearer-spectre-necromancer-1.jpg"
            heading="Acts 1–3"
            body={
      ...
      <GuideSection title="In‑Action Gallery">
        <Gallery images={['/images/starters/forged-frostbearer-spectre-necromancer-1.jpg']} />
      </GuideSection>
    </div>
  )
}
