...
export default function PoisonousConcoctionOfBouncingPathfinder({ meta }: CuratedProps) {
  return (
    <div>
      ...
      <GuideSection title="Leveling Route">
        <div className="space-y-8">
          <MediaCard
            image="/images/starters/poisonous-concoction-of-bouncing-pathfinder-1.jpg"
            heading="Acts 1–3"
            body={
