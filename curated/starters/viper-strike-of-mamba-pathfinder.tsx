...
export default function ViperStrikeOfMambaPathfinder({ meta }: CuratedProps) {
  return (
    <div>
      ...
      <GuideSection title="Leveling Route">
        <div className="space-y-8">
          <MediaCard
            image="/images/starters/viper-strike-of-mamba-pathfinder-1.jpg"
            heading="Acts 1–3"
            body={
      ...
      <GuideSection title="In‑Action Gallery">
        <Gallery images={['/images/starters/viper-strike-of-mamba-pathfinder-1.jpg']} />
      </GuideSection>
    </div>
  )
}
