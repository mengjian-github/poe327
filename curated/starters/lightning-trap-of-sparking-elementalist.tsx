...
export default function LightningTrapOfSparkingElementalist({ meta }: CuratedProps) {
  return (
    <div>
      ...
      <GuideSection title="Leveling Route">
        <div className="space-y-8">
          <MediaCard
            image="/images/starters/lightning-trap-of-sparking-elementalist-1.jpg"
            heading="Acts 1–3"
            body={
      ...
      <GuideSection title="In‑Action Gallery">
        <Gallery images={['/images/starters/lightning-trap-of-sparking-elementalist-1.jpg']} />
      </GuideSection>
    </div>
  )
}
