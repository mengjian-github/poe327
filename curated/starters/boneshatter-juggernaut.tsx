...
export default function BoneshatterJuggernaut({ meta }: CuratedProps) {
  return (
    <div>
      ...
      <GuideSection title="Leveling Route">
        <div className="space-y-8">
          <MediaCard
            image="/images/starters/boneshatter-juggernaut-1.jpg"
            heading="Acts 1–3"
            body={
      ...
      <GuideSection title="In‑Action Gallery">
        <Gallery images={['/images/starters/boneshatter-juggernaut-1.jpg']} />
      </GuideSection>
    </div>
  )
}
